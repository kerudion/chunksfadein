...
public class SkyFBO {
	...
	public void blitFromTexture(int srcTex, int srcWidth, int srcHeight, boolean restoreState) {
		...
		int lastRead = restoreState ? GL11.glGetInteger(GL30.GL_READ_FRAMEBUFFER_BINDING) : 0;
		int lastDraw = restoreState ? GL11.glGetInteger(GL30.GL_DRAW_FRAMEBUFFER_BINDING) : 0;
