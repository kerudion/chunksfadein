    ...
    private static List<OptionGroup> makeOptions() {
        ...
        groups.add(OptionGroup.createBuilder()
            ...
            .add(OptionImpl.createBuilder(boolean.class, cfiStorage)
                ...
                .setTooltip(tooltip(MOD_TAB_ENABLED).append(forceEnableTab ? Component.literal("\n").append(MOD_TAB_TOOLTIP) : empty()))
                .setControl(TickBoxControl::new)
                .setEnabled(() -> !forceEnableTab)
                .setBinding((c, v) -> setBoolean(SHOW_MOD_TAB_IN_SETTINGS_KEY, v), c -> forceEnableTab ? true : showModTabInSettings)
                .build())
            .build());
        ...
        groups.add(OptionGroup.createBuilder()
            ...
            .add(OptionImpl.createBuilder(int.class, cfiStorage)
                ...
                .setControl(o -> new SliderControl(o, roundToInt(MIN_FADE_TIME * 100), roundToInt(MAX_FADE_TIME * 100), 1, scaled(100, UNITS_SECONDS)))
                .setBinding((c, v) -> setDouble(FADE_TIME_KEY, v / 100D), c -> roundToInt(secondsFromFadeChange() * 100))
                .build())
            .build());
        ...
        groups.add(OptionGroup.createBuilder()
            ...
            .add(OptionImpl.createBuilder(int.class, cfiStorage)
                ...
                .setControl(o -> new SliderControl(o, roundToInt(MIN_ANIMATION_TIME * 100), roundToInt(MAX_ANIMATION_TIME * 100), 1, scaled(100, UNITS_SECONDS)))
                .setBinding((c, v) -> setDouble(ANIMATION_TIME_KEY, v / 100D), c -> roundToInt(secondsFromAnimationChange() * 100))
                .build())
            .add(OptionImpl.createBuilder(int.class, cfiStorage)
                .setName(translatable(ANIMATION_OFFSET))
                .setTooltip(tooltip(ANIMATION_OFFSET))
                .setControl(o -> new SliderControl(o, roundToInt(MIN_ANIMATION_OFFSET * 100), roundToInt(MAX_ANIMATION_OFFSET * 100), 1, scaled(100, UNITS_BLOCKS)))
            ...
            .add(OptionImpl.createBuilder(int.class, cfiStorage)
                ...
                .setControl(o -> new SliderControl(o, roundToInt(MIN_ANIMATION_ANGLE), roundToInt(MAX_ANIMATION_ANGLE), 1, number(UNITS_DEGREES)))
            ...
            .add(OptionImpl.createBuilder(int.class, cfiStorage)
                ...
                .setControl(o -> new SliderControl(o, roundToInt(MIN_ANIMATION_FACTOR * 100), roundToInt(MAX_ANIMATION_FACTOR * 100), 1, scaled(100)))
        ...
        groups.add(OptionGroup.createBuilder()
            ...
            .add(OptionImpl.createBuilder(int.class, cfiStorage)
                ...
                .setControl(o -> new SliderControl(o, 0, 15, 1, v -> Component.literal(String.valueOf(CURVATURE_VALUES[v]))))
                .setBinding((c, v) -> cfiStorage.setIntegerDirty(CURVATURE_KEY, CURVATURE_VALUES[v]), c -> curvatureValueIdx(worldCurvature))
                .build())
            .build());
