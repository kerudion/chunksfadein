...
<img width="150" src="readme-assets/req_fabric.png" alt="Requires Fabric API">
<img width="150" src="readme-assets/req_sodium.png" alt="Requires Sodium">
<img width="150" src="readme-assets/works_modmenu.png" alt="Works with Mod Menu">
<img width="150" src="readme-assets/works_iris.png" alt="Works with Iris Shaders">
<img width="150" src="readme-assets/crashes_opti.png" alt="Crashes with Optifabric">
...
## Versions
- [`1.18.x`](https://github.com/kerudion/chunksfadein/releases/tag/v1.0.2-1.18)
- [`1.19`-`1.19.2`](https://github.com/kerudion/chunksfadein/releases/tag/v3.0.4-1.19)
- [`1.19.3`](https://github.com/kerudion/chunksfadein/releases/tag/v2.0.4-1.19.3)
